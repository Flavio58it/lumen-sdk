...
.controller('SocialChatCtrl', function($scope, $stateParams, $log, ngstomp, $window, Settings,
    ...
    $scope.messages = [];
    $scope.toUser = {name: 'Arkan Lumen', username: 'Arkan Lumen', pic: 'x.jpg'};
    $scope.user = {name: 'You', username: 'You', pic: 'x.jpg'};
    $scope.form = {};
    ...
    $scope.client.connect(settings.stompUser, settings.stompPassword, function() {
        ...
        $scope.client.subscribe('/topic/lumen.arkan.social.chat.out', function(exchange) {
